  ...
  <div v-loading="contentLoading" class="preview" element-loading-background="rgba(0, 0, 0, 0)">
    ...
    <div class="main">
      ...
      <div class="table-body">
        ...
        <div id="download" class="download">
          <div class="background" @click="install">
            <span><img src="/img/preview/phone.png"></span>
            <button class="install-btn">{{installText}}</button>
          </div>
        </div>
      </div>
      <div class="table-foot">
        <div class="main-func">
          <div class="func-item">
            <img class="free-icon" src="/img/preview/free-icon.png">
            <img class="free-desc" src="/img/preview/free.png">
          </div>
        </div>
        <div class="func-items">
          <div class="func-item">
            <img src="/img/preview/book-icon.png">
            <div class="item-desc">
              <span class="top">教辅点读</span>
              <span class="bottom">同步教材</span>
            </div>
          </div>
          <div class="func-item">
            <img src="/img/preview/book-icon.png">
            <div class="item-desc">
              <span class="top">视频课程</span>
              <span class="bottom">知识满满</span>
            </div>
          </div>
          <div class="func-item">
            <img src="/img/preview/book-icon.png">
            <div class="item-desc">
              <span class="top">口语测评</span>
              <span class="bottom">AI智能评分</span>
            </div>
          </div>
          <div class="func-item">
            <img src="/img/preview/book-icon.png">
            <div class="item-desc">
              <span class="top">课文讲解</span>
              <span class="bottom">深入理解</span>
            </div>
          </div>
          <div class="func-item">
            <img src="/img/preview/book-icon.png">
            <div class="item-desc">
              <span class="top">听写/测验</span>
              <span class="bottom">高效掌握知识</span>
            </div>
          </div>
          <div class="func-item">
            <img src="/img/preview/book-icon.png">
            <div class="item-desc">
              <span class="top">班级功能</span>
              <span class="bottom">科学管理</span>
            </div>
          </div>
        </div>
      </div>
      ...
      install() {
        if (this.platform === "ios") {
          ...
          if (this.isWeChat || this.isQQ) {
            this.installText = "请点击右上角选择\"在浏览器打开\"";
            this.tipShow = true;
          } else {
            this.download();
          }
...
<style lang="scss" scoped>
  ...
  *, .wechat-tips {
  ...
  .table-top .app-name{
    width: 157px;
    height: 26px;
    font-family: "Rounded Mplus 1c Bold, Rounded Mplus 1c Bold";
    font-weight: 700;
    font-size: 35px;
    color: #FFFFFF;
    line-height: 52px;
  ...
  .table-body .video-back {
    ...
    margin-top: 11px;
    background: #FFFFFF;
    box-shadow: 0px 4px 10px 0px #D6F1D9;
    border-radius: 12px 12px 12px 12px;
  }

  .table-body .video-back video {
    width: 277px;
    height: 166px;
    object-fit: cover;
    margin-top: 12px;
  ...
  .table-body .download .background {
    width: 304px;
    height: 100%;
    border-radius: 8px 8px 8px 8px;
    display: flex;
    justify-content: center;
    align-items: center;
    background-color: #6CD67A;
  }

  .table-body .download .background > span {
    display: contents;
  }

  .table-body .download .background img {
    width: 20px;
    height: 20px;
    margin-right: 2px;
  }

  .table-body .download .background .install-btn {
    font-family: "Rounded Mplus 1c Bold, Rounded Mplus 1c Bold";
    font-weight: 700;
    font-size: 14px;
    color: #FFFFFF;
  ...
  .table-foot .main-func {
    margin-top: 28px;
    height: 38px;
  }

  .table-foot .func-items {
    display: flex;
    flex-wrap: wrap;
  ...
  .table-foot .main-func .func-item {
    height: 54px;
    display: flex;
    align-items: baseline;
  }

  .table-foot .main-func .free-icon {
    width: 36px;
  }

  .table-foot .main-func .free-desc {
    height: 54px;
    margin-left: 2px;
  }

  .table-foot .func-items .func-item {
    display: flex;
    margin-bottom: 22px;
  }

  .table-foot .func-items .func-item img {
    width: 36px;
  }

  .table-foot .func-items .func-item .item-desc span{
    display: block;
    text-align: left;
    font-family: "Rounded Mplus 1c, Rounded Mplus 1c";
    font-weight: 400;
    line-height: 18px;
    margin-left: 5px;
    font-style: normal;
  ...
  .table-foot .func-items .func-item .item-desc .top {
    font-size: 14px;
    color: #175B0B;
  }

  .table-foot .func-items .func-item .item-desc .bottom {
    font-size: 10px;
    color: #202C1E;
  }
